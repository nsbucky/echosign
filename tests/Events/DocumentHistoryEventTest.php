...
class DocumentHistoryEventTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreate()
    {
        ...
        $event = new DocumentHistoryEvent( $config );
        ...
        $this->assertEquals('FAXIN_RECEIVED', $event->getAgreementEventType()->getStatus());
